...
if(isset($_POST['send'])){
   ...
   if ($user_login == null) {
    mysqli_query($conn, "INSERT INTO `message`(TO_USER, FROM_USER ,MESSAGE) VALUES('null', '$user_id', '$msg')") or die('query failed');
    $message[] = 'Сообщение отправлено!';    
        ...
        if ($user){
            ...
            mysqli_query($conn, "INSERT INTO `message`(TO_USER, FROM_USER,MESSAGE) VALUES('$to_user', '$user_id', '$msg')") or die('query failed');
...
<section class="contact">
   ...
   <form action="" method="post">
      ...
      <input type="hidden" name="user_id" value = "<?php echo $_SESSION['user_id']; ?>" class="box">
      <input type="text" name="user_login" placeholder="Введите логин получателя" class="box">
